...
module.exports = (sequelize, DataTypes) => {
  ...
  const ProviderPeriods = sequelize.define('provider_periods', {
    createdAt: {
      type: DataTypes.DATE,
    },
    updatedAt: {
  ...
  ProviderPeriods.associate = (models) => {
    ProviderPeriods.belongsTo(models.periods, {
      foreignKey: {
        name: 'periodId',
        field: 'period_id',
      },
    ...
    ProviderPeriods.belongsTo(models.providers, {
      foreignKey: {
        name: 'providerId',
        field: 'provider_id',
      },
