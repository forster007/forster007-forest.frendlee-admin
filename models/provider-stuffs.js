...
module.exports = (sequelize, DataTypes) => {
  ...
  const ProviderStuffs = sequelize.define('provider_stuffs', {
    createdAt: {
      type: DataTypes.DATE,
    },
    updatedAt: {
  ...
  ProviderStuffs.associate = (models) => {
    ProviderStuffs.belongsTo(models.providers, {
      foreignKey: {
        name: 'providerId',
        field: 'provider_id',
      },
    ...
    ProviderStuffs.belongsTo(models.stuffs, {
      foreignKey: {
        name: 'stuffId',
        field: 'stuff_id',
      },
