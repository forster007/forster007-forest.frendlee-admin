...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('administrators');

// This file contains the logic of every route in Forest Admin for the collection administrators:
...
router.post('/administrators', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/administrators/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/administrators/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/administrators', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Administrators
router.get('/administrators/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Administrator
router.get('/administrators/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/administrators.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
