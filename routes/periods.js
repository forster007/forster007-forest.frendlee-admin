...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('periods');

// This file contains the logic of every route in Forest Admin for the collection periods:
...
// Create a Period
router.post('/periods', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Period
router.put('/periods/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Period
router.delete('/periods/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/periods/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Period
router.get('/periods/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/periods.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
