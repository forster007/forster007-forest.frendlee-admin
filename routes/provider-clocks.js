...
const { provider_clocks } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('provider_clocks');

// This file contains the logic of every route in Forest Admin for the collection provider_clocks:
...
// Create a Provider Clock
router.post('/provider_clocks', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Provider Clock
router.put('/provider_clocks/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Provider Clock
router.delete('/provider_clocks/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Provider Clocks
router.get('/provider_clocks', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Provider Clocks
router.get('/provider_clocks/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Provider Clock
router.get('/provider_clocks/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Provider Clocks
router.get('/provider_clocks.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
