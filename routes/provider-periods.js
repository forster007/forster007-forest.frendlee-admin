...
const { provider_periods } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('provider_periods');

// This file contains the logic of every route in Forest Admin for the collection provider_periods:
...
// Create a Provider Period
router.post('/provider_periods', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Provider Period
router.put('/provider_periods/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Provider Period
router.delete('/provider_periods/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Provider Periods
router.get('/provider_periods', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Provider Periods
router.get('/provider_periods/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Provider Period
router.get('/provider_periods/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Provider Periods
router.get('/provider_periods.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
