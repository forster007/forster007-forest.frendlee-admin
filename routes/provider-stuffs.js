...
const { provider_stuffs } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('provider_stuffs');

// This file contains the logic of every route in Forest Admin for the collection provider_stuffs:
...
// Create a Provider Stuff
router.post('/provider_stuffs', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Provider Stuff
router.put('/provider_stuffs/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Provider Stuff
router.delete('/provider_stuffs/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Provider Stuffs
router.get('/provider_stuffs', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Provider Stuffs
router.get('/provider_stuffs/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Provider Stuff
router.get('/provider_stuffs/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Provider Stuffs
router.get('/provider_stuffs.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
