...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('providers');

// This file contains the logic of every route in Forest Admin for the collection providers:
...
// Create a Provider
router.post('/providers', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Provider
router.put('/providers/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Provider
router.delete('/providers/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/providers', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Providers
router.get('/providers/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Provider
router.get('/providers/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Providers
router.get('/providers.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
