...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('ratings');

// This file contains the logic of every route in Forest Admin for the collection ratings:
...
// Create a Rating
router.post('/ratings', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Rating
router.put('/ratings/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Rating
router.delete('/ratings/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/ratings', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Ratings
router.get('/ratings/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Rating
router.get('/ratings/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Ratings
router.get('/ratings.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
